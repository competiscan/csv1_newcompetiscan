...
$time_back = mktime(0,0,0,(int)date('n')-9,(int)date('j'),(int)date('Y'));
//$time_end = mktime(0,0,0,(int)date('n')-5,(int)date('j'),(int)date('Y'));
$time_end = mktime(0,0,0,(int)date('n')-2,1,(int)date('Y'));
