...
if(isset($_SESSION['sess_userID'])){
 $loggin_user_id =  $_SESSION['sess_userID'];
  ...
  $andQuery_vist = " and loggin_user_id ='".$loggin_user_id."'";
    ...
    //$andQuery_vist = " and session_user_id ='".$session_user_id."'";
...
if($num_row > 0){
    ...
    $sql = "INSERT INTO cscan_visitor_counter SET session_user_id='".$session_user_id."', loggin_user_id='" . $loggin_user_id. "',visit_count='1'";
