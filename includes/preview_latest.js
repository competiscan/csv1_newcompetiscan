	...
	if(pid!=lastpid){
		...
		if(!testobj){
			...
			if(sample_type=='flash'){
				...
				newimg.src = from_admin+'productDocuments_latest.php?id='+pid+'&did=2';
				...
				newimg.src = from_admin+'pdfSample_latest.php?id='+pid+'&new='+ppage;
			}
...
function doGrowBox(pid){
	...
	if(sample_type=='flash'){
		...
		var attributes = {};
		swfobject.embedSWF(from_admin+"productDocuments_latest.php?id="+pid+"&did=2", 'sample_'+pid, fwidth, fheight, "9.0.0","includes/expressInstall.swf", flashvars, params, attributes);
	}
	else{
...
function pdfWin(pid) {
	var winy = window.open(from_admin+'productDocuments_latest.php?id='+pid+pdfsearch,"pdf"+pid,"menubar=yes, status=no, location=no, toolbar=yes, left=0, top=0, scrollbars=yes, resizable=yes");
	winy.focus();
}
function pdfWin_latest(pid) {
	var winy = window.open(from_admin+'productDocuments_latest.php?id='+pid+pdfsearch,"pdf"+pid,"menubar=yes, status=no, location=no, toolbar=yes, left=0, top=0, scrollbars=yes, resizable=yes");
	winy.focus();
}
...
function doPDFSample(pid) {
	if(is_admin){
		//var winy = window.open(from_admin+"admin/managepdfSample_latest.php?productID="+pid,null,"scrollbars=yes, resizable=yes, height=450,width=650,status=yes,toolbar=no,menubar=no,location=no,addressbar=yes");
		...
		if(!testobj){ 
                    ...
                    if(sample_type=='flash'){
                        ...
                        if(sample_heights[pid]){
                           ...
                           newimg.src = from_admin+'pdfSample_latest.php?id='+pid+'&new='+ppage;
                            var abc= from_admin+'pdfSample_latest.php?id='+pid+'&new='+ppage; 
                            //alert(abc);
        ...
        ajaxRequest.onreadystatechange = function(){
            if(ajaxRequest.readyState == 4){                                     
               ...
               /* Changes for S3 implementation */
                var winy = window.open('../productDocuments_latest.php?id='+pid+pdfsearch,"pdf"+pid,"menubar=yes, status=no, location=no, toolbar=yes, left=0, top=0, scrollbars=yes, resizable=yes");
                winy.focus();              
