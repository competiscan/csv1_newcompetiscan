...
if (isset($_POST['email'])) {
    ...
    $email_to = "brokers@sbkcenter.com, producers@sbkcenter.com, consumers@sbkcenter.com";
    //$email_to = "pradeep.rauthan@newmediaguru.org, pradeep.rauthan.newmediaguru@gmail.com";
    $email_subject = "Mortgage Broker Panel - New panelist submission";
...
//    }
    ...
    if(!strstr($referer_url,'sbkcenter') AND !strstr($referer_url,'google') AND !strstr($referer_url,'youtube') AND (!strstr($referer_url,'yahoo.com')) AND (!strstr($referer_url,'outlook.live')) AND $referer_url!=''){
        $email_message .= "Vendor Url: " . clean_string($referer_url) . "\n <br />";       
    }
//    $email_message .= ">";
...
//    @mail($email_to, $email_subject, $email_message, $headers);
    ...
    $hdrs = array('To' => $email_to, 'From' => 'brokers@sbkcenter.com', 'Subject' => $email_subject);
    ...
    $redirect_page=$siteUrl.'send_form_broker.php?succ=1';               
    ...
    <html xmlns="https://www.w3.org/1999/xhtml">
        ...
        <body>
            <div id="wrapper">
                <div id="header">
                    <div id="logo">
                        <p><a href="index.html"><img src="https://www.sbkcenter.com/images/sbkclogo.gif" width="210"></a></p>
                    </div>
                    <div id="menu">
                        <ul>
                                        ...
                                        <td colspan="2">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                    <tr valign="top">
                                                        <td>
                                                            <h1>SBKC Mortgage Broker Panel</h1>
                                                            </br>
                                                            <p></p>
            ...
            <div id="footer"> 
                ...
                <P>
                    ...
                    <a href="https://www.sbkcenter.com/">www.sbkcenter.com</a>
                </P>
            </div>
            <!-- Add tracking code -->
<!--            <iframe src="https://forwardrocketlaunch.com/p.ashx?o=21442&e=336&t=TRANSACTION_ID" height="1" width="1" frameborder="0"></iframe>-->
            <iframe src="https://roi-rocket.org/p.ashx?o=21442&e=336&t=TRANSACTION_ID" height="1" width="1" frameborder="0"></iframe>
           <?php if(!strstr($referer_url,'sbkcenter') AND (!strstr($referer_url,'google')) AND (!strstr($referer_url,'youtube')) AND (!strstr($referer_url,'yahoo.com')) AND (!strstr($referer_url,'outlook.live')) AND $referer_url!=''){?>
