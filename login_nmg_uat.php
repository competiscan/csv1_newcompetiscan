			...
			<form name="loginForm" action="login.php" method="post" onsubmit="return validate();">
                ...
                <div class="row form-row button-container">
                    <div class="col-md-12 text-center">
						...
						<a class="btn btn-primary" href="<?php echo AUTH_URL_NMG; ?>response_type=code&client_id=<?php echo CLIENT_ID_NMG; ?>&redirect_uri=https://competiscan.com/sso_auth_uat.php">Login with SSO</a>
                    </div>
                </div>
