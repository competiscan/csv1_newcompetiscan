...
$updID = '';
$fromtemp = true;
include 'admin/addProductPersistenceAndLogic.php';
 // Restrict media channel email case
$disabledButton='';
if($mChannelID==3){
  $disabledButton ='disabled'; 
}
$url = "temp_product.php?muid=".$muid;
if($isTmp){
	$url .= '&amp;isTmp='.$isTmp;
}
$url .= '&amp;hy='.$hy;
$disabled = '';
include 'admin/addProductFormBuilder.php';
...
if(isset($_POST['save'])) {
	...
	include 'admin/addProductJSandPopups.php';
	?>
	<script type="text/javascript">
	<!--
	function doUPOnload(){
