...
if($productID!=0){
	...
	$query2 = "SELECT img_document_sort,img_document_filename,img_document_content_type,img_document_size_byte,UNIX_TIMESTAMP(img_document_createddate),document_id,img_document_path,sample_img_status,bucket_name FROM {$tablename} WHERE productID=$productID AND document_id=$document_id$where";
