    ...
    <body onload="hideSWFDiv();">
        ...
        ?>
                                ...
                                if ($document_size_byte > 0 && !$makePDF && $productRs['mChannelID']!=10){
                                        ?>
                                        <?php if (($productRs['mChannelID']=='5') || ($productRs['mChannelID']=='9')){ if($thepdf!=''){ ?> <iframe border="0" src="<?php echo $thepdf;?>" >
                                        </iframe> <?php } }else{ ?><a class="bluelink" href="<?php echo $thepdf; ?>" onclick="printAll(<?php echo $productID; ?>, '<?php echo $thepdf; ?>', 3);
                                                    return false;">View PDF Content <img src="images/pdf.jpg" border="0" style="vertical-align:top;" /></a> <?php } ?>  &nbsp; <?php if(($productRs['mChannelID']!='5') && ($productRs['mChannelID']!='9') && ($productRs['mChannelID']!='10')){ ?> [<?php echo $DisplaySize; ?>] <?php } ?><br />
                                        <?php
                                ...
                                if($hosts=='localhost'){
                                    $baseurl='http://localhost/comepetiscan_latest/Competiscan-master';
                            ...
                            if($document_content_type=='html' && $row2[0]!=''){
                                    ...
                                    $img_link=$baseurl.$row2[0].$document_filename;                                       }else{
                                        $img_link='';
                                    }    
                           
                            if($document_content_type=='video/mp4' && $img_link!=''){
                                 $content='<video width="350" height="150" controls>
                            <source src="' .$baseurl.$video_link . '" type="video/mp4">
                 ...
                 //changes for panelist id show for digital
                        ...
                        if (($productRs['mPanelID'] == 1 || $productRs['mPanelID'] == 2) && ($productRs['mChannelID']!=6 )) {//consumer ||  Emp/Biz direct mail
               ...
               ?>
                ...
                <tr>
                            <td class="bodytext" valign="top" width="50%">
                                <?php if($showdevice!=''){?>
                                <strong>Digital Source:</strong>&nbsp;&nbsp;<?php echo $showdevice; }else{ echo '&nbsp;'; } ?>
                                </td>
                    <td class="bodytext" valign="top" width="50%">
                        <?php if($showdomain!=''){ ?>
                        <strong>Simple Domain:</strong>&nbsp;&nbsp;<?php echo $showdomain;}else{ echo '&nbsp'; } ?>
                                </td>
                </tr>  
          <?php }              
             /*####### For show digital source and simple domain ####### */               
