...
if($num_of_rows > 0){
	...
	while($dataB = $DRW->fetch_row($rs)){
		...
		<tr><td><a href=\"fullresults_latest.php?bid=$basket_id\"><img src=\"images/edit.png\" border=\"0\" /></a></td><td><a class=\"HyperLink\" href=\"fullresults_latest.php?bid=$basket_id\">View</a></td></tr>";
		//if($_SESSION['sess_plevel']>0){ //removed 12/12 @ Nate's request, jm
			echo "<tr><td><a class=\"HyperLink\" href=\"productImages_latest.php?pp=1&amp;bid=$basket_id\" target=\"_blank\"><img src=\"images/ppt.jpg\" border=\"0\" /></a></td><td><a class=\"HyperLink\" href=\"productImages_latest.php?pp=1&amp;bid=$basket_id\" target=\"_blank\">PowerPoint</a></td></tr>";
			echo "<tr><td><a  class=\"HyperLink\" href=\"exportDocument_latest.php?pdf=1&amp;bid=$basket_id\"><img src=\"images/pdf.jpg\" border=\"0\" /></a></td><td><a id=\"$basket_id\" class=\"HyperLink\" href=\"exportDocument_latest.php?pdf=1&amp;bid=$basket_id\"><span id='pdf_hide_$basket_id'>PDF</span></a><div class=\"loder_hide\" id=\"loder_$basket_id\"><img src=\"images/searching.gif\" alt=\"\" border=\"0\" height=\"16\" width=\"16\" /></div></td></tr>";
		//}
