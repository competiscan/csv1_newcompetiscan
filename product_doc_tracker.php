...
function track_search_activity($userID,$ID) {
	...
	$copyArray = array(
            ...
            'is_mobile','value_score','refinance','jumbo_ncnfg','va','fha','conventional','usda','correspondent_lending','faux_check','minmaxmortgage','socialmedia_adtype','publication_name','deliveryTypeId','postageId','presortedId','packageTypeId','fico_score','credit_vision_score','vantage_score','sender_domain_name','tip_on_card',
        );
