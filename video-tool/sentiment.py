...
if records is not None:
	for row in records:
		...
		updt_query_main="Update cscan_youtube_video set is_completed=1 where id=%s "
		updt_data_main = (vid,)
...
#subprocess.call(['python','/var/www/html/competiscan.com/video-tool/download-video1.py'])
