...
if(isset($_REQUEST['deletebut']) && $_REQUEST['deletebut']==1 && isset($_REQUEST['delID'])) {
	...
	ob_end_clean();
	header("Location: manageTrends_test.php");
	exit;
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="5" class="text">
	<tr><td class="adminhead" align="center">TREND REPORT MANAGEMENT</td></tr>
		...
		<form method="post" name="searchForm" action="manageTrends_test.php" onsubmit="return check_searchform();" style="display:inline;">
        ...
        <tr style="display: inline-block; width: 100px; margin: -32px 0 0 180px;">
            <td>
                <form action="manageTrends_test.php" method="post" style="display:inline;">
		<table border="0" cellspacing="0" cellpadding="1" class="text">
                    <tbody>
                        <tr>
                           <td align="right"></td>
	...
	<tr>
            <td>
            <form method="post" name="communicationForm" action="manageTrends_test.php">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="text">
                    <tr>
                    <td><strong>Note:</strong>  Click any of the following to modify the trend.</td>
                    <td align="right">
                    <input class="button" type="button" value="Add Trend" onclick="location.href='addTrend_test.php'; return false;" />
                    </td>
                    <td align="right"> 
...
<form action="manageTrends_test.php" method="post" name="deleteform">
<table width="100%" border="0" cellspacing="0" cellpadding="5" class="text">
  <tr>
...
?>
        ...
        <td><a class="hlinks" href="addTrend_test.php?id=<?php echo $ID;?>" title="Click here to edit."><?php echo $trend_name;?> </a></td>
		...
		<td align="center"><a class="hlinks" href="addTrend_test.php?id=<?php echo $ID;?>" title="Click here to edit."><img src="../images/edit.png" border="0" /></a></td>
	  </tr>
      <?php
		}
	}
