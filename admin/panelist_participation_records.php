                ...
                <table width='100%' border="0" cellspacing="0" cellpadding="1" class="text">
                    <tr>
                        ...
                        <td align="left" width='20%'>
                            ...
                            <a href="panelist_participation_records.php" class="button" style="width:60px;height: 25px; color:#fff;cursor: pointer;text-decoration: none;box-shadow: 1px 1px 0 #5d5d5d;padding: 2px 8px;">Clear</a>
                            <?php endif;?>
                        </td>
                        </form>
        ...
        <td>
            <table width='100%' border='0' cellspacing='0' cellpadding='8' class='text' rules='none' bordercolor='#B9B9B9' align='center' style='border-collapse:collapse'>
                ...
                while($row = $DRW->fetch_assoc($rs)){
                    ...
                    $siteurl= 'http://'.$_SERVER['HTTP_HOST'].'/'.str_replace('admin/panelist_participation_records.php','',$_SERVER['SCRIPT_NAME']);
                    //echo $siteurl;die;
                    ?>
