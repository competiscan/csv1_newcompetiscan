...
function doPDFSample(pid) {
	var winy = window.open("<?php if($fromtemp) echo 'admin/'; ?>managepdfSample_old.php?productID="+pid,null,"scrollbars=yes, resizable=yes, height=450,width=650,status=yes,toolbar=no,menubar=no,location=no,addressbar=yes");
	winy.focus();
}
