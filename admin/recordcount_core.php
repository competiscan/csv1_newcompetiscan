...
$corecategoryarray=array('Core Approved','Core Problem','Core Reprocessed','Core Unapproved', 'Core Non-Panelist Unapproved','Core FTP' );
...
if($category=='Core Approved') {
   $where="   productStatus=1 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372) AND ((scsc_sectorID=0 AND DMSource NOT LIKE '%non%' AND DMSource NOT LIKE '%\_NC\_%' AND DMSource NOT LIKE '%telecom%' AND DMSource NOT LIKE '%\_TC\_%' AND DMSource NOT LIKE '%\_TL\_%') OR scsc_sectorID=4 OR scsc_sectorID=5) AND pd.mChannelID<>5 AND is_citi<>1 "; 
   
   
    
}
else if($category=='Core Problem') {
...
else if($category=='Core Reprocessed') {
...
else if($category=='Core Unapproved') {
   $where=" productStatus=2 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372) AND ((scsc_sectorID=0 AND DMSource NOT LIKE '%non%' AND DMSource NOT LIKE '%\_NC\_%' AND DMSource NOT LIKE '%telecom%' AND DMSource NOT LIKE '%\_TC\_%' AND DMSource NOT LIKE '%\_TL\_%') OR scsc_sectorID=4 OR scsc_sectorID=5) AND pd.mChannelID<>5 AND is_subp<>1 AND is_citi<>1 AND consumer_insights<>1   ";
}
else if($category=='Core Non-Panelist Unapproved') {
   $where=" productStatus=2 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372) AND ((scsc_sectorID=0 AND DMSource NOT LIKE '%non%' AND DMSource NOT LIKE '%\_NC\_%' AND DMSource NOT LIKE '%telecom%' AND DMSource NOT LIKE '%\_TC\_%' AND DMSource NOT LIKE '%\_TL\_%') OR scsc_sectorID=4 OR scsc_sectorID=5) AND pd.mChannelID<>5 AND is_subp=1 ";
}
else if($category=='Core FTP') {
   $where=" productStatus=5 AND pd.mChannelID<>5 AND is_citi<>1 AND consumer_insights<>1 ";
}
