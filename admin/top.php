...
<?php /*
if(basename($_SERVER['PHP_SELF']) != 'main.php' && basename($_SERVER['PHP_SELF']) != 'index.php') {
   ?>
<div style="text-align:right;font-weight:bold;margin-right:20px;"><a onclick="return removeNewTab(this);" data-href="main.php">Back To Menu</a></div>
<?php
}
