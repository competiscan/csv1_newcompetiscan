...
$adminArray['Banner Content'] = array(
	array(41,'Banner Products Approved', 'manageproduct_test.php?pstat=1&amp;cstat=7'),
	array(41,'Banner Products Problem', 'manageproduct_test.php?pstat=4&amp;cstat=7'),
	array(41,'Banner Products Reprocessed', 'manageproduct_test.php?pstat=3&amp;cstat=7'),
	array(41,'Banner Products Unapproved', 'manageproduct_test.php?pstat=2&amp;cstat=7'),
...
$adminArray['Mobile Content'] = array(
	array(41,'Mobile Products Approved', 'manageproduct_test.php?pstat=1&amp;cstat=12'),
	array(41,'Mobile Products Problem', 'manageproduct_test.php?pstat=4&amp;cstat=12'),
	array(41,'Mobile Products Reprocessed', 'manageproduct_test.php?pstat=3&amp;cstat=12'),
	array(41,'Mobile Products Unapproved', 'manageproduct_test.php?pstat=2&amp;cstat=12'),
	array(41,'0'),
);
if(checkGroup(37)){
	...
	$adminArray['Consumer Insight'] = array(
		array(33,'CI Unapproved ('.number_format($aun).')','manageproduct_test.php?pstat=2&amp;cstat=10'),
		array(33,'CI FTP ('.number_format($anew).')','manageproduct_test.php?pstat=6&amp;cstat=10'),
		array(33,'0')
	);
	...
	$adminArray['CITI Content'] = array(
		array(37,'CITI Approved ('.number_format($app).')','manageproduct_test.php?pstat=1&amp;cstat=11'),
		array(37,'CITI Unapproved ('.number_format($aun).')','manageproduct_test.php?pstat=2&amp;cstat=11'),
		array(37,'CITI Problem ('.number_format($apr).')','manageproduct_test.php?pstat=4&amp;cstat=11'),
		array(37,'CITI Reprocessed ('.number_format($are).')','manageproduct_test.php?pstat=3&amp;cstat=11'),
		array(37,'CITI Unused ('.number_format($unu).')','manageproduct_test.php?pstat=-1&amp;cstat=11'),
		array(37,'CITI FTP ('.number_format($anew).')','manageproduct_test.php?pstat=6&amp;cstat=11'),
		array(37,'0')
	);
}
...
foreach($adminArray as $title=>$vals){
	...
	if($title=='Direct Mail Content' && count($AUTH_DATA['SID'])>0){
		...
		foreach($ctypeArray as $ckey=>$core){
			...
			array_unshift($vals,array(4,$core.' FTP ('.number_format($new).')','manageproduct_test.php?pstat='.$ckey.'&amp;cstat=0'));
			if($ckey==266 || $ckey==315){
				...
				$dataV = $DRW->fetch_row($checkV);
				$unu = $dataV[0];
				array_unshift($vals,array(4,$core.' Unused ('.number_format($unu).')','manageproduct_test.php?pstat=-1&amp;cstat='.$ckey));
			}
			if($ckey==9 || $ckey==6 || $ckey==5){
				...
				$dataV = $DRW->fetch_row($checkV);
				$uns = $dataV[0];
				array_unshift($vals,array(4,$core.' Non-Panelist Unapproved ('.number_format($uns).')','manageproduct_test.php?pstat=-2&amp;cstat='.$ckey));
			}
			array_unshift($vals,array(4,$core.' Unapproved ('.number_format($un).')','manageproduct_test.php?pstat=2&amp;cstat='.$ckey));
			array_unshift($vals,array(4,$core.' Reprocessed ('.number_format($rep).')','manageproduct_test.php?pstat=3&amp;cstat='.$ckey));
			array_unshift($vals,array(29,$core.' Problem ('.number_format($prob).')','manageproduct_test.php?pstat=4&amp;cstat='.$ckey));
			array_unshift($vals,array(4,$core.' Approved','manageproduct_test.php?pstat=1&amp;cstat='.$ckey));
		}
	}
