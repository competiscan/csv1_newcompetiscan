...
require_once '../includes/MailVolumeCalculator_latest.php';
...
for($i=$start_year;$i<=$to_year;$i++){
	foreach($month_name as $key=>$value){
		...
		$calc_date_range2 = date('Y-m',$ctime).'-01 00:00:00';
                ...
                echo $sql_c = "SELECT SQL_NO_CACHE COUNT(*) FROM cscan_panelists_product WHERE ppdate>='2022-07-01 00:00:00' AND ppdate<'2022-08-01 00:00:00' AND productID=9504442 ";
