...
var pathToImages = 'js_calendar/images/';	// Relative to your HTML file
...
function closeCalendar(){
	...
	if((returnDateTo.name=='firstSeen' || returnDateTo.name=='entryID') && document.prodForm && document.prodForm.firstSeen){
		if(returnDateTo.name=='entryID' && document.prodForm.entryID){
			document.prodForm.firstSeen.value = document.prodForm.entryID.value.substring(0,10);
		}
		if(document.prodForm.firstSeen.value!='' && document.prodForm.lastSeen){
			document.prodForm.lastSeen.value = document.prodForm.firstSeen.value.substring(0,10);
		}
	}
}
...
function writeCalendarContent()
{
   ...
   if (showWeekNumber) {
	...
	for(var no=1;no<=daysInMonth;no++){
		...
		if(returnDateTo.name=='OfferExpiryDate' || currentYear<dnow.getFullYear() || (currentYear==dnow.getFullYear() && (currentMonth<dnow.getMonth() || (currentMonth==dnow.getMonth() && no<=dnow.getDate())))){
