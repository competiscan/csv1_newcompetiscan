...
/* #### End For digital module ### */
        ...
        if ($updID != '') {
            ...
            $sql = "insert into cscan_product_detail set 
				...
				IssueTypeID='$IssueTypeID',
				consumer_insights=$consumer_insights,
				is_subp=$is_subp,is_digital='1',is_mobile=$is_mobile,panelist_id='".$save_pd_pan."',panelist_sort='".$panelist_sort."',simple_domain ='".$simple_domain."'";
...
//        } 
       ...
       ############## for mobile digital headline automatic writing ################# 
        ...
        if ($error_pdf > 0) {
            ...
            if($red_digital_id=='1'){            
             ...
             if($is_digital_temp!=''){
                 $redirect_url = "manage_tmp_digital_product.php";      
             }
        }
        ob_end_clean();
       ...
       // }
        ...
        if($editmode=='1' AND $is_digital_temp!=''){
            $redirect_url = "manage_tmp_digital_product.php";      
        }
