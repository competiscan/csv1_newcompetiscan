...
function corerecordcountCalculate($corecategoryarray,$mchannelid,$countrycode){
 ...
 for($c=0;$c<count($corecategoryarray);$c++){  
   ...
   $where="   productStatus=10 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372)     "; 
    ...
    foreach($mchannelid as $key=>$val){ 
      ...
      $orderby=" ORDER BY product_priority DESC,special_handling DESC,actual_addedToDatabase DESC"; 
        $allsql=$sql." Where ".$where.$andclause.$orderby;
