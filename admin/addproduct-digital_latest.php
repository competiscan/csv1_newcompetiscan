...
$simple_domain = '';
$error_msg = '';
$url = "addproduct-digital_latest.php";
if (isset($_GET['muid'])) {
    $disabled = ' disabled="disabled"';
    $url = "addproduct_latest.php?muid=" . $_GET['muid'];
...
if (isset($_GET['id'])) {
    $updID = $_GET['id'];
    $url = "addproduct-digital_latest.php?id=$updID";
...
include 'addProductPersistenceAndLogic-digital_latest.php';

include 'addProductFormBuilder-digital_latest.php';
?>
    ...
    <tr>
        <td>
            <form method="post" name="prodForm" action="<?php echo $url; ?>" onsubmit="return validate();" enctype="multipart/form-data"><input type="hidden" name="MAX_FILE_SIZE" value="64000000" />
                ...
                <?php
                include 'addProductJSandPopups-digital_latest.php';
                include 'bottom.php';
