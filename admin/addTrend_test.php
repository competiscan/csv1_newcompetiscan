...
<?php
    ...
    if(isset($_POST['submity'],$_POST['submit']) && ($_POST['submit']=='Save' || $_POST['submit']=='Save & Add More')){
            ...
            if($_POST['submit'] == 'Save & Add More'){
                     ob_end_clean();
                     header("Location: addTrend_test.php?a=1");
                     exit;
             }
...
?>
    <tr>
        ...
        <table border="0" cellspacing="0" cellpadding="4">
                ...
                <tr>
                    <td class="bodytext" align="right" valign="top"><span class='error'>*</span>Category:</td>
                <td class ="bodytext">
                <?php
                $coreArray = array();
            ...
            <tr>
                ...
                <?php }?>
                <input class="button" type="button" value="Cancel" onclick="location.href='manageTrends_test.php'; return false;" />
                </td>
            </tr>
	</table>
	</td></tr>
...
function do_SCSC(obj,type,obj_to,asy){
	...
	processajax('<?php echo '../admin/'; ?>scsc_info.php', asy, 'POST', type+'='+tid, obj_to, 'doInnerSelect');
}
