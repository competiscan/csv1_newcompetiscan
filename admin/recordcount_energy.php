...
$corecategoryarray=array('Energy Approved','Energy Problem','Energy Reprocessed','Energy Unapproved', 'Energy Unused','Energy FTP' );
...
if($category=='Energy Approved') {
   $where="   productStatus=1 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372) AND ((scsc_sectorID=0 AND (DMSource LIKE '%\_EN\_%')) OR scsc_sectorID=315) AND pd.mChannelID<>5 AND is_citi<>1    "; 
    
}
else if($category=='Energy Problem') {
...
else if($category=='Energy Reprocessed') {
...
else if($category=='Energy Unapproved') {
   $where=" productStatus=2 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372) AND ((scsc_sectorID=0 AND (DMSource LIKE '%\_EN\_%')) OR scsc_sectorID=315) AND pd.mChannelID<>5 AND is_subp<>1 AND is_citi<>1 AND consumer_insights<>1  ";
}

else if($category=='Energy Unused') {
   $where=" productStatus=-1 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372) AND ((scsc_sectorID=0 AND (DMSource LIKE '%\_EN\_%')) OR scsc_sectorID=315) AND pd.mChannelID<>5 AND is_citi<>1  ";
}

else if($category=='Energy FTP') {
   $where=" productStatus=315 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372) AND pd.mChannelID<>5 AND is_citi<>1 AND consumer_insights<>1  ";
