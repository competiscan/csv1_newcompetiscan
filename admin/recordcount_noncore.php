...
$corecategoryarray=array('NonCore Approved','NonCore Problem','NonCore Reprocessed','NonCore Unapproved', 'NonCore Non-Panelist Unapproved','NonCore FTP' );
...
if($category=='NonCore Approved') {
   $where="   productStatus=1 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372) AND ((scsc_sectorID=0 AND (DMSource LIKE '%non%' OR DMSource LIKE '%\_NC\_%')) OR scsc_sectorID=6 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=262 OR scsc_sectorID=372) AND pd.mChannelID<>5 AND is_citi<>1 "; 
    
}
else if($category=='NonCore Problem') {
...
else if($category=='NonCore Reprocessed') {
...
else if($category=='NonCore Unapproved') {
   $where=" productStatus=2 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372) AND ((scsc_sectorID=0 AND (DMSource LIKE '%non%' OR DMSource LIKE '%\_NC\_%')) OR scsc_sectorID=6 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=262 OR scsc_sectorID=372) AND pd.mChannelID<>5 AND is_subp<>1 AND is_citi<>1 AND consumer_insights<>1 ";
}
else if($category=='NonCore Non-Panelist Unapproved') {
   $where="  productStatus=2 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372) AND ((scsc_sectorID=0 AND (DMSource LIKE '%non%' OR DMSource LIKE '%\_NC\_%')) OR scsc_sectorID=6 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=262 OR scsc_sectorID=372) AND pd.mChannelID<>5 AND is_subp=1 ";
}
else if($category=='NonCore FTP') {
   $where=" productStatus=6 AND pd.mChannelID<>5 AND is_citi<>1 AND consumer_insights<>1  ";
}
