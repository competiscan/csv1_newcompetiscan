...
if(isset($_GET['id'])){
	$updID = $_GET['id'];
	$url = "addproduct_latest.php?id=$updID";
        //$ONLOAD .= 'doPromotionRetailCompany('.$_GET['id'].')';
}
...
$fromtemp = false;
include 'addProductPersistenceAndLogic_latest.php';
include 'addProductFormBuilder_latest.php';
...
<?php
include 'addProductJSandPopups_latest.php';
//include 'bottom.php';
