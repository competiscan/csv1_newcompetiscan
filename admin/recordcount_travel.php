...
$corecategoryarray=array('Travel & Leisure Approved','Travel & Leisure Problem','Travel & Leisure Reprocessed','Travel & Leisure Unapproved', 'Travel & Leisure FTP' );
...
if($category=='Travel & Leisure Approved') {
   $where="   productStatus=1 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372) AND ((scsc_sectorID=0 AND (DMSource LIKE '%\_TL\_%')) OR scsc_sectorID=219) AND pd.mChannelID<>5 AND is_citi<>1  "; 
    
}
else if($category=='Travel & Leisure Problem') {
...
else if($category=='Travel & Leisure Reprocessed') {
...
else if($category=='Travel & Leisure Unapproved') {
   $where="  productStatus=2 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372) AND ((scsc_sectorID=0 AND (DMSource LIKE '%\_TL\_%')) OR scsc_sectorID=219) AND pd.mChannelID<>5 AND is_subp<>1 AND is_citi<>1 AND consumer_insights<>1 ";
}

else if($category=='Travel & Leisure FTP') {
   $where=" productStatus=219 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372) AND pd.mChannelID<>5 AND is_citi<>1 AND consumer_insights<>1  ";
