...
$corecategoryarray=array('Retail Approved','Retail Problem','Retail Reprocessed','Retail Unapproved', 'Retail Unused','Retail FTP' );
...
if($category=='Retail Approved') {
   $where="   productStatus=1 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372) AND ((scsc_sectorID=0 AND (DMSource LIKE '%\_RL\_%')) OR scsc_sectorID=266) AND pd.mChannelID<>5 AND is_citi<>1   "; 
    
}
else if($category=='Retail Problem') {
...
else if($category=='Retail Reprocessed') {
...
else if($category=='Retail Unapproved') {
   $where="  productStatus=2 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372) AND ((scsc_sectorID=0 AND (DMSource LIKE '%\_RL\_%')) OR scsc_sectorID=266) AND pd.mChannelID<>5 AND is_subp<>1 AND is_citi<>1 AND consumer_insights<>1 ";
}

else if($category=='Retail Unused') {
   $where=" productStatus=-1 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372) AND ((scsc_sectorID=0 AND (DMSource LIKE '%\_RL\_%')) OR scsc_sectorID=266) AND pd.mChannelID<>5 AND is_citi<>1 ";
}

else if($category=='Retail FTP') {
   $where=" productStatus=266 AND (scsc_sectorID=0 OR scsc_sectorID=4 OR scsc_sectorID=5 OR scsc_sectorID=6 OR scsc_sectorID=9 OR scsc_sectorID=87 OR scsc_sectorID=90 OR scsc_sectorID=219 OR scsc_sectorID=266 OR scsc_sectorID=315 OR scsc_sectorID=372) AND pd.mChannelID<>5 AND is_citi<>1 AND consumer_insights<>1 ";
