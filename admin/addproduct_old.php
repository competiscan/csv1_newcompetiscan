...
$error_msg = '';
$url = "addproduct_old.php";
if(isset($_GET['muid'])){
	$disabled = ' disabled="disabled"';
	$url = "addproduct_old.php?muid=".$_GET['muid'];
...
if(isset($_GET['id'])){
	$updID = $_GET['id'];
	$url = "addproduct_old.php?id=$updID";
}
...
$fromtemp = false;
include 'addProductPersistenceAndLogic_old.php';
include 'addProductFormBuilder_old.php';
...
<?php
include 'addProductJSandPopups_old.php';
//include 'bottom.php';
