...
$error_msg = '';
$url = "addproduct_test.php";
if(isset($_GET['muid'])){
	$disabled = ' disabled="disabled"';
	$url = "addproduct_test.php?muid=".$_GET['muid'];
...
if(isset($_GET['id'])){
	$updID = $_GET['id'];
	$url = "addproduct_test.php?id=$updID";
}
...
$fromtemp = false;
include 'addProductPersistenceAndLogic_test.php';
include 'addProductFormBuilder_test.php';
...
<?php
include 'addProductJSandPopups_test.php';
//include 'bottom.php';
