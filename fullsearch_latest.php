...
if(isset($_POST['send'])){
	...
	ob_end_clean();
	header("Location: fullresults_latest.php?ssid=$search_id");
	exit;
}
elseif($search_id!=0){
...
?>
	...
	<div style="float:left;padding:4px;"><?php 
		...
		?>
		<input class="submitbutton" id="enhance_button" type="submit" name="refine_search" value="<?php echo $enhance_text; ?>" onclick="setEnhance(); return false;" />
