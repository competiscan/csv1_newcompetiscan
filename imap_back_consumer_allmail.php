         ...
         for ($i = 1; $i <=500; $i++) {
            if ($imap_stream) {
                ...
                if (isset($header->from))
                    ...
                    $from = '';
                ############ for the new setting of consumer need to assign from with replyto #########
...
//                }
                ...
                if ($count[0] == 0) {
                    ...
                    if ($keep) {
                        ...
                        if ((preg_match('/\\bfwd?\\b/i', $subject) || preg_match('/\\brv\\b/i', $subject) || preg_match('/\\btr\\b/i', $subject))) {
                            imap_mail_move($imap_stream, $i, '[Gmail]/Trash');
