...
/**
 * The present user has inadequate permissions to perform the task requested
 */
 ...
 * methods for creating DB objects as well as common utility functions
 * for other DB classes.
 *
...
class DB
{
    ...
    public static function getDSNString($dsn, $hidePassword) {
         ...
         * defined, and means that we deal with strings and array in the
         * same manner. */
...
class DB_result
{
     ...
     * able to retrieve data from result sets if the statement handle is
     * still in scope.}}
     *
     * @var resource
     * @since Property available since Release 1.7.0
