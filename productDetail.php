...
if ($hosts == 'localhost') {
    ...
    $baseurl = 'https://demo.competiscan.com';
} else {
...
if(ENV == 'localhost'){
    ...
    $displayS3PdfUrl='https://files1.competiscan.com/';
}else{
...
<html xmlns="https://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body onload="hideSWFDiv();">
		...
		WHERE pa.companyID=pp.companyID AND pp.productID=$productID AND primary_co=1", $DRW_read);
            ...
            $query2 = "SELECT document_size_byte,document_filename,document_path,document_content_type,document_placement,bucket_name FROM cscan_document WHERE productID=$productID AND document_id=$document_id";
                ...
                <div style="margin:0px;padding:0px;border:solid 1px #0055E3;width:99%;">
                    <table width="100%" cellpadding="4" cellspacing="0" class="likeresults" border="0">
                        ...
                        <tr>
                            ...
                            {
                                ?>
                                <td valign="top" colspan="2"><img src="<?php echo $baseurl; ?>/productImg.php?<?php echo $pi; ?>" style="border: solid 1px #000000;float:left;" alt="" />
                                    <?php
                                ...
                                ?>
                                <td valign="top"><img src="<?php echo $baseurl; ?>/productImg.php?<?php echo $pi; ?>" style="border: solid 1px #000000;" alt="" /></td>
                                <td class="bodytext" valign="bottom">
                                    ...
                                    { 
                                      ...
                                      <?php } ?> &nbsp; <?php if (($productRs['mChannelID'] != '5') && ($productRs['mChannelID'] != '9') && ($productRs['mChannelID'] != '10')) { ?> [<?php echo $DisplaySize; ?>] <?php } ?>
                                       ...
                                       ################# Start for Anotation Tool Link Permission################  
                                        ...
                                        if(isset($_SESSION['sess_anotation_tool_link']) AND in_array('anotation_tool_link',$_SESSION['sess_anotation_tool_link'])){ 
                                            if(($productRs['mChannelID']==3) AND ($productRs['mPanelID']==1|| $productRs['mPanelID']==2)) {
                                            //if(($productRs['mChannelID']==3) AND ($productRs['mPanelID']==1|| $productRs['mPanelID']==2) AND ($productRs['sectorID']==266) AND ($productRs['categoryID']==269) ) {   
                                                ...
                                                $query_result_prod_email = $DRW->query($queryProdEmail,$DRW_read);
                                                 ...
                                                 if($numrows2>0){
                                                    ...
                                                    //$displayAnotationLink='https://ml-anotation.competiscan.com/v1/data-analysis/'.$muID."/".(int)$mail_volume_tot;
                                                    //$displayAnotationLink=ANNOTATIONTOOLDATAANALYSISURL.$muID."/".(int)$mail_volume_tot;
                                                    $displayAnotationLink=ANNOTATIONTOOLDATAANALYSISURL.$muID;
                                                    ?>
                                                    &nbsp;<a href="javascript:var w=window.open('<?php echo $displayAnotationLink; ?>', '_blank', 'width=650,height=550');" class="bluelink" title="Co-op Spend"><img width="15" height="15" src="bar-graph.png" border="0" style="vertical-align:top;" /></a>
                                                <?php }
                                            }
                                      ...
                                      <?php
                                        ...
                                        $viewfullLink='';
                                        $content_link='';
                                        $sql2 = "SELECT document_path,document_content_type,document_filename,bucket_name FROM cscan_document WHERE productID=$productID AND document_id=1";
                                        ...
                                        if($check_bucket_name!='NULL' AND $check_bucket_name!=''){
                                            $s3VideoURL = $displays3CSV2URL.substr($video_link,0);
                                        }else{
                                            $s3VideoURL = $displays3URL.substr($video_link,1);
                                        }
                                        if ($document_content_type == 'video/mp4' || $document_content_type=='video/mpeg-4' || $document_content_type=='image/mpeg-4' && $img_link != '') {
                            ...
                            <td class="bodytext" valign="top" width="50%"><strong>Entry ID:</strong> <?php
                                if ($_SESSION['sess_plevel'] > 0) {
                                    /*if ($productRs['is_digital'] == '1') {
                                        ...
                                        //echo '<a href="'.$adminProductDigitalUrl.'" target="_blank" class="bluelink">';  
                                        echo "<a href=\"admin/addproduct-digital.php?id=$productID$add\" target=\"_blank\" class=\"bluelink\">";
                                    }else*/
                                    if ($productRs['mChannelID']==3 || $productRs['mChannelID']==1 || $productRs['mChannelID']==2 || $productRs['mChannelID']==6 || $productRs['mChannelID']==14 || $productRs['mChannelID']==5 || $productRs['mChannelID']==9 || $productRs['mChannelID']==10) {
                                        $ec_content_type='email';
                                        if($productRs['mChannelID']==1){
                                         $ec_content_type='direct';  
                                        }
                                        if($productRs['mChannelID']==2){
                                            $ec_content_type='print_media';  
                                        }
                                        if($productRs['mChannelID']==6){
                                            $ec_content_type='social_media';  
                                        }
                                        if($productRs['mChannelID']==14){
                                            $ec_content_type='website_url';  
                                        }
                                        if($productRs['mChannelID']==5){
                                            $ec_content_type='mobiledigital&product_status=1';  
                                        }
                                        if($productRs['mChannelID']==9){
                                            $ec_content_type='mobiledigital&product_status=1';  
                                        }
                                        if($productRs['mChannelID']==10){
                                            $ec_content_type='mobiledigital&product_status=1'; 
                                        }
...
//                                            }
    ...
    ?>
        ...
        var winy = window.open(baseurl+'/productDocuments.php?id='+pid,"video","menubar=yes, status=no, location=no, toolbar=yes, left=0, top=0, scrollbars=yes, resizable=yes");
	winy.focus();
        }
        </script>
