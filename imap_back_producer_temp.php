...
$sql = "DROP TABLE IF EXISTS cscan_damaxmail_duplicate_tmp";
if($DRW->query($sql, $DRW_main)){
    $sql = "CREATE TABLE IF NOT EXISTS cscan_damaxmail_duplicate_tmp LIKE cscan_damaxmail_duplicate";
    $DRW->query($sql, $DRW_main);
}
                        ...
                        if ($parti != '') {
                            ...
                            if ($bodydata != '') {
                                if ($type_no == 0 && ($subtype == 'plain' || $subtype == 'html')) {
                                    ...
                                    echo $query;
                                    if($DRW->query($query, $DRW_main)){echo '$subtype => '.$subtype.'</br>';
                                        if($subtype == 'html'){echo '$subtype => '.$subtype.'</br>';
                                            copydaMaxmailHtml($muid,$bodydata);
                                        }
