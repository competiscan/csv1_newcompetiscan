...
$ps = $path.$productID.'_'.$rand_num.'_.ps';
$jpg = $path.$productID.'_'.$rand_num.'_%d.jpg';
$jpg0 = $path.$productID.'_'.$rand_num.'_0.jpg';
...
if($document_id!=0){
	$AUTH_DATA = array();
	$AUTH_DATA['userID'] = 0;
        savePDFImage1($productID,$document_id,$path);
        //echo $test; die;
}
