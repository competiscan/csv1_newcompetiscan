                        ...
                        if ($parti != '') {
                            ...
                            if ($bodydata != '') {
                                if ($type_no == 0 && ($subtype == 'plain' || $subtype == 'html')) {
                                  ...
                                  //  $bodydata= utf8_encode(htmlspecialchars($bodydata, ENT_QUOTES | ENT_HTML5));
                                    
                                  //echo   $query = "INSERT INTO `cscan_email_text` (`cetpart`,`cettext`,`cettype`,`muid`,`cetidentification`) VALUES ('" . $DRW->real_escape_string($parti) . "','" . ($DRW->real_escape_string(utf8_encode($bodydata))) . "','" . $DRW->real_escape_string($type . '/' . $subtype) . "','" . $DRW->real_escape_string($muid) . "','" . $DRW->real_escape_string($id) . "')";
                                //  echo   $query = "INSERT INTO `cscan_email_text` (`cetpart`,`cettext`,`cettype`,`muid`,`cetidentification`) VALUES ('" . $DRW->real_escape_string($parti) . "','" . $DRW->real_escape_string (($bodydata)) . "','" . $DRW->real_escape_string($type . '/' . $subtype) . "','" . $DRW->real_escape_string($muid) . "','" . $DRW->real_escape_string($id) . "')";
